...
const stack_exports_container_1 = require("./stack-exports-container");
class AwsDiagramGenerator extends __1.DiagramGenerator {
    ...
    generate(cdkTree, collapse, collapseDoubleClusters, includedStacks = false, excludedStacks = undefined) {
        ...
        if (excludedStacks)
            this.removeExcludedStacks(diagram, excludedStacks);
    ...
    generateComponent(cdkNode, parentComponent) {
        ...
        if (cdkNode.constructInfoFqn && cdkNode.constructInfoFqn.typ === cdk.ConstructInfoFqnType.STACK) {
            ...
            if (exportsNode) {
                try {
                    component.stackExportsContainer = stack_exports_container_1.StackExportsContainer.fromComponent(exportsNode);
                }
                catch (e) { }
            }
        }
    ...
    removeExcludedStacks(diagram, excludedStackIds) {
        diagram.root.subTreeApplyAllComponents((component) => {
            const isStack = this.isStack(component);
    ...
    idInList(includedStacks, component) {
